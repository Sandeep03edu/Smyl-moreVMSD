...
public class MsongVideo extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String media_url = songNameShrd.getString("songVideoIdESP", "");
...
//        String media_url = "https://youtu.be/VQttXb6qE6k";
    ...
    public void launchVideo(View view){
        startActivity(new Intent(MsongVideo.this, MsongVideo.class));
    }
}
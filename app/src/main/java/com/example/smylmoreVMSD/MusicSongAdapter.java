...
public class MusicSongAdapter extends RecyclerView.Adapter<MusicSongAdapter.SongHolder> {

    private ArrayList<SongInfo> _songs = new ArrayList<SongInfo>();
    private Context context;
    private OnItemClickListener mOnItemClickListener;

    public MusicSongAdapter(Context context, ArrayList<SongInfo> songs) {

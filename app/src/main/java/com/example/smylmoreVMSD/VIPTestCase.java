...
public class VIPTestCase extends AppCompatActivity {
...
//                }
    ...
    public void validation(int pin1,int pin2,int pin3,int pin4, GridView gridView){
        if(pin1 == 0 && pin2 == 7 && pin3==0 && pin4 ==7){
            Toast.makeText(VIPTestCase.this, "Correct Pin", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(VIPTestCase.this, Vip.class));
            pin1=0; pin2=0; pin3=0; pin4=0;
            setPinTextValue(pin1,pin2,pin3,pin4);
            setpin1Value(gridView);
        }
        else{
            Toast.makeText(VIPTestCase.this, "Wrong Pin" + pin1 + pin2 + pin3+ pin4, Toast.LENGTH_SHORT).show();
            pin1=0; pin2=0; pin3=0; pin4=0;
            setPinTextValue(pin1,pin2,pin3,pin4);
            setpin1Value(gridView);
        }

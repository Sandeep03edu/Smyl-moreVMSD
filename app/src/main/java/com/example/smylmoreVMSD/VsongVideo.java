...
public class VsongVideo extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String media_url = VsongNameShrd.getString("VsongVideoIdESP", "");
    ...
    public void launchVideo(View view){
        startActivity(new Intent(VsongVideo.this, VsongVideo.class));
    }
}
...
public class DsongVideo extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String media_url = DsongNameShrd.getString("DsongVideoIdESP", "");
    ...
    public void launchVideo(View view){
        startActivity(new Intent(DsongVideo.this, DsongVideo.class));
    }
}
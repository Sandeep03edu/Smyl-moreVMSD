...
public class SsongVideo extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String media_url = SsongNameShrd.getString("SsongVideoIdESP", "");
    ...
    public void launchVideo(View view){
        startActivity(new Intent(SsongVideo.this, SsongVideo.class));
    }
}